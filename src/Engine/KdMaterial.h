...
namespace xe {
    ...
    public:
        // Constructor
        KdMaterial(const glm::vec4 &Kd, int use_vertex_colors=false) : Kd_(Kd), use_vertex_colors_(use_vertex_colors), Textura_(0) {};
        
        KdMaterial(const glm::vec4 &Kd, int use_vertex_colors, GLuint& Textura) : Kd_(Kd), use_vertex_colors_(use_vertex_colors), Textura_(Textura) {};
